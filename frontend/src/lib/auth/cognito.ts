/**
 * Cognito client wrapper for Automation Platform authentication
...
const STORAGE_KEYS = {
  ACCESS_TOKEN: 'automation_platform_access_token',
  ID_TOKEN: 'automation_platform_id_token',
  REFRESH_TOKEN: 'automation_platform_refresh_token',
  USER_EMAIL: 'automation_platform_user_email',
} as const;

// Create user pool instance (lazily)
