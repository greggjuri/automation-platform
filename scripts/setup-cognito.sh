...
# Create Cognito User Pool and App Client for Automation Platform authentication

REGION="us-east-1"
POOL_NAME="automation-platform-users"
CLIENT_NAME="automation-platform-web"

echo "=== Automation Platform Cognito Setup ==="
echo ""
  ...
  CREATE_POOL_OUTPUT=$(aws cognito-idp create-user-pool \
    ...
    --admin-create-user-config '{
      ...
      "InviteMessageTemplate": {
        "EmailSubject": "Automation Platform Admin Invite",
