...
## Arguments
- `$ARGUMENTS` - Path to the PRP file (e.g., `PRPs/PRP-001-webhook-receiver.md`)

## Instructions

You are executing a PRP (Project Requirement Plan) for this automation platform project.
...
4. Run existing tests to ensure clean baseline: `cd lambdas && pytest -q` (if applicable)
...
```
/execute-prp PRPs/PRP-001-webhook-receiver.md
```
